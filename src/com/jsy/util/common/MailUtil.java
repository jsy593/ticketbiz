...
public class MailUtil {
	...
	public static void main(String[] args){  
	    ...
	    String from = "jwchen_tk@qq.com";  
	    String to = "847164438@qq.com";
	    //String copyto = "sslf_vip@163.com";  

	    String subject = "测试2";
	    String content = "<h1>jwchen.tk</h1><font>jwchen.tk</font><a href='www.baidu.com'>www.baidu.com</a>";  
	    String username="jwchen_tk@qq.com";
	    String password="sslf109824";
	    //String filename = "G:\\aa.jpg";
